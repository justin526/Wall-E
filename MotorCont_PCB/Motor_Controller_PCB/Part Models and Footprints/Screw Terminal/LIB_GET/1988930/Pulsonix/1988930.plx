...
(library Library_1
	...
	(patternDef "1988930" (originalName "1988930")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 34.600, 3.700) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 -2.7) (pt 72.5 -2.7) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 72.5 -2.7) (pt 72.5 10.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 72.5 10.1) (pt -2.5 10.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 10.1) (pt -2.5 -2.7) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "1988930" (originalName "1988930") (compHeader (numPins 15) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.mouser.it/datasheet/2/324/ItemDetail_1988930-923961.pdf")
		(attr "<Component Height>" "12.05")
		(attr "<STEP Filename>" "1988930.stp")
