...
(library Library_1
	...
	(patternDef "C503B-BCN" (originalName "C503B-BCN")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.389, 0.06) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 0, 0) (radius 2.9) (startAngle 30.5) (sweepAngle 299.1) (width 0.025))
		)
		(layerContents (layerNumRef 18)
		...
		(layerContents (layerNumRef 28)
			(line (pt 2.5 1.46969) (pt 2.5 -1.46969) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(arc (pt 2.949, 0.013) (radius 0) (width 0.1))
		)
	)
	...
	(compDef "C503B-BCN-CV0Z0461" (originalName "C503B-BCN-CV0Z0461") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/C503B-BCN-CV0Z0461.pdf")
	)
